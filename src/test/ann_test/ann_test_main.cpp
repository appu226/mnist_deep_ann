...
void multiNeuronTest()
{
    ...
    auto w000 = network->addWeight();
    auto w001 = network->addWeight();
    auto n00 = network->addNeuron(f, 2);
    network->connectInputToNeuron(i0, n00, { 0 });
    network->connectInputToNeuron(i1, n00, { 1 });
    network->connectWeightToNeuron(w000, n00, { 0 });
    network->connectWeightToNeuron(w001, n00, { 1 });
    
    auto w010 = network->addWeight();
    auto w011 = network->addWeight();
    auto n01 = network->addNeuron(f, 2);
    network->connectInputToNeuron(i0, n01, { 0 });
    network->connectInputToNeuron(i1, n01, { 1 });
    network->connectWeightToNeuron(w010, n01, { 0 });
    network->connectWeightToNeuron(w011, n01, { 1 });

    auto w100 = network->addWeight();
    auto w101 = network->addWeight();
    auto n10 = network->addNeuron(f, 2);
    network->connectNeurons(n00, n10, { 0 });
    network->connectNeurons(n01, n10, { 1 });
    network->connectWeightToNeuron(w100, n10, { 0 });
    network->connectWeightToNeuron(w101, n10, { 1 });
    
    auto w110 = network->addWeight();
    auto w111 = network->addWeight();
    auto n11 = network->addNeuron(f, 2);
    network->connectNeurons(n00, n11, { 0 });
    network->connectNeurons(n01, n11, { 1 });
    network->connectWeightToNeuron(w110, n11, { 0 });
    network->connectWeightToNeuron(w111, n11, { 1 });
    ...
    {
        w = {
            { network->getWeight(w000), network->getWeight(w001) },
            { network->getWeight(w010), network->getWeight(w011) },
            { network->getWeight(w100), network->getWeight(w101) },
            { network->getWeight(w110), network->getWeight(w111) }
        };
    }
    ...
    RVec errorSensitivityToNeurons;
    {
        errorSensitivityToWeights = {
            { network->getErrorSensitivityToWeight(w000), network->getErrorSensitivityToWeight(w001) },
            { network->getErrorSensitivityToWeight(w010), network->getErrorSensitivityToWeight(w011) },
            { network->getErrorSensitivityToWeight(w100), network->getErrorSensitivityToWeight(w101) },
            { network->getErrorSensitivityToWeight(w110), network->getErrorSensitivityToWeight(w111) }
        };
        errorSensitivityToNeurons = {
            network->getErrorSensitivityToNeuronOutput(n00),
            network->getErrorSensitivityToNeuronOutput(n01),
            network->getErrorSensitivityToNeuronOutput(n10),
            network->getErrorSensitivityToNeuronOutput(n11)
        };
    }
